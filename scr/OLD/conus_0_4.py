...
pathOut = '/home/konstantin/PycharmProjects/RayTracer/files/settingsfiles/Ray_4_5.xls'
...
x4RayData.append(Xin[0])
x4RayData.append(Xout[0])
x4RayData.append(np.nan)

x4RayData.append(Xin[7])
x4RayData.append(Xout[7])
x4RayData.append(np.nan)

x4RayData.append(Xin[15])
x4RayData.append(Xout[15])
x4RayData.append(np.nan)

y4RayData.append(Yin[0])
y4RayData.append(Zout[0])
y4RayData.append(np.nan)

y4RayData.append(Yin[7])
y4RayData.append(Zout[7])
y4RayData.append(np.nan)

y4RayData.append(Yin[15])
y4RayData.append(Zout[15])
y4RayData.append(np.nan)

z4RayData.append(Zin[0])
z4RayData.append(Yout[0])
z4RayData.append(np.nan)

z4RayData.append(Zin[7])
z4RayData.append(Yout[7])
z4RayData.append(np.nan)

z4RayData.append(Zin[15])
z4RayData.append(Yout[15])
z4RayData.append(np.nan)
...
py.offline.plot(fig, filename='conus_04.html')
py.offline.plot(fig1, filename='conus_InOut_04.html')
