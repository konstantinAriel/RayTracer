...
for i in range(40, 59):
    ...
    XinPoint3.append(Xin[i])
    ZinPoint3.append(Zin[i])
...
for i in range(0, 19):
    ...
    XpolarDataIn1.append(Xin[i])
    XpolarDataIn1.append(XeIn[i])
    XpolarDataIn1.append(np.nan)

    YpolarDataIn1.append(Yin[i])
    YpolarDataIn1.append(YeIn[i])
    YpolarDataIn1.append(np.nan)

    ZpolarDataIn1.append(Zin[i])
    ZpolarDataIn1.append(ZeIn[i])
    ZpolarDataIn1.append(np.nan)
    ...
    YpolarDataOut1.append(ZeOut[i])
    YpolarDataOut1.append(np.nan)

    ZpolarDataOut1.append(Yout[i])
    ZpolarDataOut1.append(YeOut[i])
    ZpolarDataOut1.append(np.nan)

    XoutPoint3.append(Xout[i])
    YoutPoint3.append(Yout[i])
...
polarDict1  = dict(
                go.Scatter3d(x=XpolarDataIn1, y=YpolarDataIn1, z=ZpolarDataIn1,
                     mode='lines',
                     name='PolarIn',
                     line=dict(width=2, color='blue')
                     ))
polarDictOut1  = dict(
                go.Scatter3d(x=XpolarDataOut1, y=YpolarDataOut1, z=ZpolarDataOut1,
                     mode='lines',
                     name='PolarOut',
...
for i in range(20, 39):
    ...
    XpolarDataIn2.append(Xin[i])
    XpolarDataIn2.append(XeIn[i])
    XpolarDataIn2.append(np.nan)

    YpolarDataIn2.append(Yin[i])
    YpolarDataIn2.append(YeIn[i])
    YpolarDataIn2.append(np.nan)

    ZpolarDataIn2.append(Zin[i])
    ZpolarDataIn2.append(ZeIn[i])
    ZpolarDataIn2.append(np.nan)

    XpolarDataOut2.append(Xout[i])
    XpolarDataOut2.append(XeOut[i])
    XpolarDataOut2.append(np.nan)

    YpolarDataOut2.append(200)
    YpolarDataOut2.append(ZeOut[i])
    YpolarDataOut2.append(np.nan)

    ZpolarDataOut2.append(Yout[i])
    ZpolarDataOut2.append(YeOut[i])
    ZpolarDataOut2.append(np.nan)

    XoutPoint2.append(Xout[i])
    YoutPoint2.append(Yout[i])
...
polarDict2  = dict(
                go.Scatter3d(x=XpolarDataIn2, y=YpolarDataIn2, z=ZpolarDataIn2,
                     mode='lines',
                     name='PolarIn',
                     line=dict(width=2, color='blue')
                     ))
polarDictOut2  = dict(
                go.Scatter3d(x=XpolarDataOut2, y=YpolarDataOut2, z=ZpolarDataOut2,
                     mode='lines',
                     name='PolarOut',
                     line=dict(width=2, color='red')
                     ))
...
for i in range(40, 59):
    ...
    XpolarDataIn3.append(Xin[i])
    XpolarDataIn3.append(XeIn[i])
    XpolarDataIn3.append(np.nan)

    YpolarDataIn3.append(Yin[i])
    YpolarDataIn3.append(YeIn[i])
    YpolarDataIn3.append(np.nan)

    ZpolarDataIn3.append(Zin[i])
    ZpolarDataIn3.append(ZeIn[i])
    ZpolarDataIn3.append(np.nan)
    ...
    YpolarDataOut3.append(ZeOut[i])
    YpolarDataOut3.append(np.nan)

    ZpolarDataOut3.append(Yout[i])
    ZpolarDataOut3.append(YeOut[i])
    ZpolarDataOut3.append(np.nan)
...
polarDict3  = dict(
                go.Scatter3d(x=XpolarDataIn3, y=YpolarDataIn3, z=ZpolarDataIn3,
                     mode='lines',
                     name='PolarIn',
                     line=dict(width=2, color='blue')
                     ))
polarDictOut3  = dict(
                go.Scatter3d(x=XpolarDataOut3, y=YpolarDataOut3, z=ZpolarDataOut3,
                     mode='lines',
                     name='PolarOut',
                     line=dict(width=2, color='red')
                     ))
...
z4RayData.append(Yout[x1])
z4RayData.append(np.nan)

z4RayData.append(Zin[x2])
z4RayData.append(Yout[x2])
z4RayData.append(np.nan)

z4RayData.append(Zin[x3])
z4RayData.append(Yout[x3])
z4RayData.append(np.nan)
...
layout = dict(width=1920, height=1200,
                      ...
                      title='In from Source reflection from Mirror 1 ', hovermode='closest',
...
data2.append(polarDict1)
data2.append(polarDict2)
data2.append(polarDict3)
data2.append(polarDictOut1)
data2.append(polarDictOut2)
data2.append(polarDictOut3)

fig = dict(data=data1, layout=layout)
fig1 =  dict(data=data2, layout=layout)
py.offline.plot(fig, filename='conus_0_1.html')
py.offline.plot(fig1, filename='conus_InOut_0_1.html')
